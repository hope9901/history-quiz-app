...
- 문항은 국사편찬위원회 주관 **한국사능력검정시험 제72·75·76회(심화)** 의 [공식 홈페이지 시험자료실](https://www.historyexam.go.kr/pst/list.do?bbs=dat)에서 공개한 문제지·정답표 원문을 문항 단위 이미지로 잘라 **변형 없이** 수록한 것입니다.
- 라이선스: [공공누리 제4유형](https://www.kogl.or.kr/info/license.do) (출처표시 · 상업적 이용금지 · 변경금지) — 본 프로젝트는 비영리 개인 학습용입니다.
- 제73·74회는 공개 문제지가 스캔 이미지 PDF라 문항 단위 자동 분할이 불가능하여 제외했습니다.
